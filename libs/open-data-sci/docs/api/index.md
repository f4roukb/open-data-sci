...
| [Background Tasks](tasks.md) | `BackgroundTaskManagerBase`, `BackgroundTaskManager`, `BackgroundTaskRecord`, `BackgroundTaskStatus`, `BackgroundTaskProgressReport` — the data model behind background-scheduled worker subtasks |
