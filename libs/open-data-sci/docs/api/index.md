...
| [Background Tasks](tasks.md) | `AgentTaskManagerBase`, `LocalAgentTaskManager`, `TaskRecord`, `TaskStatus`, `TaskProgressReport` — the data model behind background-scheduled worker subtasks |
